...
import TogglePrivacy from "../../common/Togglers/TogglePrivacy";
    ...
    <div className={styles["add-newchat-window-container"]}>
      ...
      >
        {!isCreate ? (
            ...
            <div className={styles["add-newchat-window-main"]}>
              ...
              <div className={styles["add-newchat-window-privacy-container"]}>
                <div className={styles["add-newchat-window-privacy-text"]}>
                  ...
                  <p className={styles["add-newchat-window-privacy-text-hint"]}>
                    Пригласить в эту группу сможете только Вы
                  </p>
                </div>
                <div>
                  <TogglePrivacy />
              ...
              <div
                className={styles["add-newchat-window-main-next-btn-container"]}
              >
                <button
                  className={styles["add-newchat-window-main-next-btn"]}
                  onClick={ChangeCreateWindow}
                >
                  Далее
                </button>
              </div>
          ...
          <div className={styles["add-newchat-window-next-container"]}>
            <div className={styles["add-newchat-window-next-header"]}>
              <div className={styles["add-newchat-window-next-back-container"]}>
                <img
                  className={styles["add-newchat-window-next-back"]}
                  onClick={ChangeCreateWindow}
                  alt=""
                />
              </div>
              <div
                className={styles["add-newchat-window-next-title-container"]}
              >
                <p>Новая группа</p>
              </div>
            </div>
            <div className={styles["add-newchat-window-next-main-container"]}>
              <p className={styles["add-newchat-window-next-main-title"]}>
                <b>Кто будет в моей группе?</b>
              </p>
              <p className={styles["add-newchat-window-next-main-hint"]}>
